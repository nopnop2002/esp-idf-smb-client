...
void app_main(void)
{
	...
	char smburl[64];
	//strcpy(smburl, "smb://nop@192.168.10.50/share/esp-idf-cat.txt");
	sprintf(smburl, "smb://%s@%s/%s/esp-idf-cat.txt", CONFIG_ESP_SMB_USER, CONFIG_ESP_SMB_HOST, CONFIG_ESP_SMB_PATH);
